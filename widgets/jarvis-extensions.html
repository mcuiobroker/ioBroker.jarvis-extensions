...
<link rel="stylesheet" href="widgets/jarvis-extensions/css/style.css" />
<!-- here you can include so many js-files as you want -->
<script type="text/javascript" src="widgets/jarvis-extensions/js/jarvis-extensions.js"></script>
...
<!-- the full description of format in data-vis-attrs can be found here:
	...
	Mandatory XML attributes:
		id="tplJarvis-extensionsWIDGETNAME"
		type="text/ejs"
		class="vis-tpl"
	...
	data-vis-prev
		...
		data-vis-prev='<img src="widgets/hqwidgets/img/prev/Prev_tplJarvis-extensionsShowInstance.png"></img>'
...
-->
<script id="tplJarvis-extensionsShowInstance"
		type="text/ejs"
		class="vis-tpl"
		data-vis-prev='<div id="prev_tplJarvis-extensionsShowInstance" style="position: relative; text-align: initial;padding: 4px "><div class="vis-widget_prev " style="width: 280px; height: 159px;" > <div class="jarvis-extensions-class vis-widget-prev-body " style="padding:2px"> OID: hm-rpc.0.EEQ0006629.1.STATE<br> OID value: true<br> Color: <span style="color: rgb(128, 0, 0);">#800000</span><br> htmlText: <textarea readonly="" style="width:100%">asda</textarea></div>'
		data-vis-attrs="oid/id;myColor/color;htmlText/text;"
		data-vis-attrs0="group.extraJarvis-extensions;extraAttr"
		data-vis-set="jarvis-extensions"
	...
	<div class="vis-widget <%== this.data.attr('class') %>" style="width:230px; height:210px;" id="<%= this.data.attr('wid') %>" >
		<div class="jarvis-extensions-class vis-widget-body <%== this.data.attr('class') %>" style="padding:2px" >
...
<script id="tplJarvis-extensionsHelper"
		type="text/ejs"
		class="vis-tpl"
		data-vis-prev='<div id="prev_tplJarvis-extensionsHelper" style="position: relative; text-align: initial;padding: 4px "><div class="vis-widget_prev " style="width: 280px; height: 159px;" > <div class="jarvis-extensions-class vis-widget-prev-body " style="padding:2px"> OID: hm-rpc.0.EEQ0006629.1.STATE<br> OID value: true<br> Color: <span style="color: rgb(128, 0, 0);">#800000</span><br> htmlText: <textarea readonly="" style="width:100%">asda</textarea></div>'
		data-vis-attrs="oid/id;myColor/color;htmlText/text;"
		data-vis-attrs0="group.extraJarvis-extensions;extraAttr"
		data-vis-set="jarvis-extensions"
		data-vis-type="helper"
	...
	<div class="vis-widget <%== this.data.attr('class') %>" style="overflow:visible; width: 230px; height: 210px" id="<%= this.data.attr('wid') %>"><%
		vis.binds['jarvis-extensions'].createWidget(this.data.wid, this.view, this.data, this.style);
	%></div>
</script>